...
public class BudgetCategoryTest {
	...
	public void testBudgetCategory(){
		try {
			...
			assertEquals((double) 100, bc.getAmountOfBudgetPeriodContainingDate(DateUtil.getDate(2007, Calendar.APRIL, 1)), 1);
			assertEquals((double) 100, bc.getAmountOfBudgetPeriodContainingDate(DateUtil.getDate(2007, Calendar.APRIL, 10)), 1);
			assertEquals((double) 100, bc.getAmountOfBudgetPeriodContainingDate(DateUtil.getDate(2007, Calendar.APRIL, 28)), 1);
	...
	public void budgetPeriodWeekly() throws Exception {
		...
		assertEquals(100l,
				bc.getAmountOfBudgetPeriodContainingDate(DateUtil.getDate(2007, Calendar.OCTOBER, 1)));
		assertEquals(14l,
				bc.getTotalAmount(
