...
I created Buddi because I wanted a simple to use budgeting software 
which does not require a degree in accounting to use.  All software 
which I previously tried to use seemed either too complex or did not 
have the features which I wanted.
...
For bug reports, suggestions, or just to let me know that you are using 
the program, please email me.
