...
public class EditViewScheduledTransactions extends MossMenuItem{
	...
	public EditViewScheduledTransactions(AccountFrame frame) {
		super(frame, PrefsModel.getInstance().getTranslator().get(MenuKeys.MENU_EDIT_VIEW_SCHEDULED_ACTIVITIES));
	}

	@Override
	public void actionPerformed(ActionEvent e) {
		try {
			ScheduleFrame scheduledTransactionsFrame = new ScheduleFrame(((AccountFrame) getFrame()).getDataModel(), (AccountFrame) getFrame());
