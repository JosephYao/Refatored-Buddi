...
public abstract class BuddiSynchronizePlugin implements MossPlugin {
	 ...
	 */
	public abstract void synchronizeData(MutableDocument model, MossDocumentFrame callingFrame, File file);
