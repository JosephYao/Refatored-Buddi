...
public class TransactionsNotReconciled extends BuddiReportPlugin {
	...
	public HTMLWrapper getReport(DataManager dataManager, Date startDate, Date endDate) {
		...
		if (!PrefsInstance.getInstance().getPrefs().isShowAdvanced()){
			...
			sb.append("<h1>")
			.append(Translate.getInstance().get(TranslateKeys.REPORT_TRANSACTIONS_NOT_RECONCILED))
			.append("</h1>");
	...
	public String getDescription() {
		return TranslateKeys.REPORT_DESCRIPTION_TRANSACTIONS_NOT_RECONCILED.toString();
	}
