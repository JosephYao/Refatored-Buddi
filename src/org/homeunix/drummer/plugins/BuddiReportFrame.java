...
public class BuddiReportFrame extends AbstractFrame {
	...
	public BuddiReportFrame(BuddiReportPlugin reportPlugin, final Date startDate, final Date endDate){
	...
	protected AbstractFrame initActions() {
		...
		okButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {
				BuddiReportFrame.this.setVisible(false);
			}
		});
