...
public interface BuddiMenuPlugin extends BuddiFilePlugin {
	 ...
	 * be an array of classes, such as MainBuddiFrame.class, 
	 * TransactionsFrame.class, and so forth.  If you want
	 * your plugin to appear in all windows, set this to null.
	 * @return An array of classes representing the windows to appear in.
	 */
