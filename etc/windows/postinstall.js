...
objShell.regwrite("HKCR\\BuddiData\\shell\\open\\command\\", objArgs(0) + "\\Buddi.exe %L");
...
objShell.regwrite("HKCR\\BuddiPlugin\\shell\\open\\command\\", objArgs(0) + "\\Buddi.exe %L");
...
objShell.regwrite("HKCR\\BuddiLang\\shell\\open\\command\\", objArgs(0) + "\\Buddi.exe %L");
