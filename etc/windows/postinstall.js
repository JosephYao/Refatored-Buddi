...
objShell.regwrite("HKCR\\BuddiPlugin\\shell\\open\\command\\", "\"" + objArgs(0) + "\\Buddi.exe\" --windows-installer \"%1\"");
...
objShell.regwrite("HKCR\\BuddiLang\\shell\\open\\command\\", "\"" + objArgs(0) + "\\Buddi.exe\" --windows-installer \"%1\"");
